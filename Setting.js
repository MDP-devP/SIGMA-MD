...
global.owner = process.env.OWNER_NUMBER  || '237692280295' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "66ab249fd42bb65e03e33ed6" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "237692280295" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"🐉Monkey-Bot🤞🐉",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://image.noelshack.com/fichiers/2024/31/4/1722491296-otaku-food-20240722-205549-0000.jpg
' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '01_08_2024_SIGMA_MD_LYxnwQEi_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Monkey-Bot',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `🐉Monkey🐉`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Monkey-Bot',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "sticker-Monkey" ,          // ADD YOUR STICKER PACKNAME
